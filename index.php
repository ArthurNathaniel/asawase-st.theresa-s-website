...
<head>
    ...
    <title>Home - St. Theresa Parish</title>
    <?php include 'cdn.php'; ?>
...
<body>
        ...
        <div class="services-grid">
            <div class="services-box">
                ...
                <div class="services-details">
                    <h4> <i class="fa fa-church"></i>Sunday First Mass</h4>
                    <h5><i class="fa fa-clock"></i> 6:30am - 8:30am</h5>
                </div>
            </div>
            <div class="services-box">
                <div class="services-img">
                ...
                <div class="services-details">
                    <h4> <i class="fa fa-church"></i> Sunday Second Mass</h4>
                    <h5><i class="fa fa-clock"></i> 8:30am - 10:30am </h5>
                </div>
            </div>
            <div class="services-box">
                <div class="services-img">
                ...
                <div class="services-details">
                    <h4><i class="fa fa-church"></i> Weekdays Mass (Mon- Sat)</h4>
                    <h5><i class="fa fa-clock"></i> 6:00am - 7:00am</h5>
                </div>
            </div>
        </div>
    </section>
    <section>
        <div class="row about-grid">
            <div class="about-text">
                <h5>ASAWASE ST. THERESA CATHOLIC CHURCH</h5>
                <h1>About Us</h1>
                <p>
    ...
    <section id="event">
        <div class="events-heading">
            <h1>Upcoming events at St. Theresa Parish</h1>
        </div>
